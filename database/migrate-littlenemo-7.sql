...
-- littlenemo-6c.sql and apps/gcd/migration/history_issues.py must be run first
update oi_changeset set modified = created where created < "2009-12-07";
update oi_issue_revision set modified = created where created < "2009-12-07";
drop table log_issues;
drop table log_issues2;
