...
CREATE TABLE `core_cover` (
  ...
  KEY `covercode` (`issue_sort_code`),
  KEY `HasImage` (`has_image`),
  KEY `c2` (`has_medium`),
  KEY `c4` (`has_large`),
  KEY `Yr_Began` (`year_began`)
) ENGINE=MyISAM AUTO_INCREMENT=613916 DEFAULT CHARSET=utf8;

DELIMITER ;;
/*!50003 SET SESSION SQL_MODE="" */;;
/*!50003 CREATE */ /*!50017 DEFINER=`gcd_dev`@`localhost` */ /*!50003 TRIGGER `pre_insert_cover` BEFORE INSERT ON `core_cover` FOR EACH ROW BEGIN
...
/*!50003 SET SESSION SQL_MODE="" */;;
/*!50003 CREATE */ /*!50017 DEFINER=`gcd_dev`@`localhost` */ /*!50003 TRIGGER `pre_update_cover` BEFORE UPDATE ON `core_cover` FOR EACH ROW IF new.sequence_number != old.sequence_number OR
...
) ENGINE=MyISAM AUTO_INCREMENT=629924 DEFAULT CHARSET=utf8;

DELIMITER ;;
/*!50003 SET SESSION SQL_MODE="" */;;
/*!50003 CREATE */ /*!50017 DEFINER=`gcd_dev`@`localhost` */ /*!50003 TRIGGER `pre_insert_issue` BEFORE INSERT ON `core_issue` FOR EACH ROW BEGIN
        SET new.publisher_name=
...
/*!50003 SET SESSION SQL_MODE="" */;;
/*!50003 CREATE */ /*!50017 DEFINER=`gcd_dev`@`localhost` */ /*!50003 TRIGGER `post_insert_issue` AFTER INSERT ON `core_issue` FOR EACH ROW UPDATE core_series s SET s.issue_count=s.issue_count + 1
        WHERE s.id = new.series_id */;;

/*!50003 SET SESSION SQL_MODE="" */;;
/*!50003 CREATE */ /*!50017 DEFINER=`gcd_dev`@`localhost` */ /*!50003 TRIGGER `pre_update_issue` BEFORE UPDATE ON `core_issue` FOR EACH ROW IF new.series_id != old.series_id THEN
        SET new.series_name=
            (SELECT s.name FROM core_series s WHERE s.id = new.series_id);
        SET new.year_began=
            (SELECT s.year_began FROM core_series s WHERE s.id = new.series_id);
...
/*!50003 SET SESSION SQL_MODE="" */;;
/*!50003 CREATE */ /*!50017 DEFINER=`gcd_dev`@`localhost` */ /*!50003 TRIGGER `post_update_issue` AFTER UPDATE ON `core_issue` FOR EACH ROW BEGIN
...
/*!50003 SET SESSION SQL_MODE="" */;;
/*!50003 CREATE */ /*!50017 DEFINER=`gcd_dev`@`localhost` */ /*!50003 TRIGGER `post_delete_issue` AFTER DELETE ON `core_issue` FOR EACH ROW UPDATE core_series s SET s.issue_count=s.issue_count - 1
        WHERE s.id = old.series_id */;;
...
DELIMITER ;;
/*!50003 SET SESSION SQL_MODE="" */;;
/*!50003 CREATE */ /*!50017 DEFINER=`gcd_dev`@`localhost` */ /*!50003 TRIGGER `post_update_publisher` AFTER UPDATE ON `core_publisher` FOR EACH ROW BEGIN
...
CREATE TABLE `core_reservation` (
  ...
  KEY `IssueID` (`issue_id`),
  KEY `Status` (`status`)
) ENGINE=MyISAM AUTO_INCREMENT=86909 DEFAULT CHARSET=utf8;
...
) ENGINE=MyISAM AUTO_INCREMENT=766617 DEFAULT CHARSET=utf8;

DELIMITER ;;
/*!50003 SET SESSION SQL_MODE="" */;;
/*!50003 CREATE */ /*!50017 DEFINER=`gcd_dev`@`localhost` */ /*!50003 TRIGGER `pre_insert_sequence` BEFORE INSERT ON `core_sequence` FOR EACH ROW BEGIN
        SET new.issue_number=
            (SELECT `number` FROM core_issue i WHERE i.id = new.issue_id);
        SET new.series_id=
            (SELECT series_id FROM core_issue i WHERE i.id = new.issue_id);
...
/*!50003 SET SESSION SQL_MODE="" */;;
/*!50003 CREATE */ /*!50017 DEFINER=`gcd_dev`@`localhost` */ /*!50003 TRIGGER `post_insert_sequence` AFTER INSERT ON `core_sequence` FOR EACH ROW UPDATE core_issue i SET i.sequence_count=i.sequence_count + 1
        WHERE i.id = new.issue_id */;;

/*!50003 SET SESSION SQL_MODE="" */;;
/*!50003 CREATE */ /*!50017 DEFINER=`gcd_dev`@`localhost` */ /*!50003 TRIGGER `post_update_sequence` AFTER UPDATE ON `core_sequence` FOR EACH ROW IF new.`number` != old.`number` THEN
        UPDATE core_cover c SET c.sequence_number=new.`number`
            WHERE c.sequence_id = new.id;
    END IF */;;

/*!50003 SET SESSION SQL_MODE="" */;;
/*!50003 CREATE */ /*!50017 DEFINER=`gcd_dev`@`localhost` */ /*!50003 TRIGGER `post_delete_sequence` AFTER DELETE ON `core_sequence` FOR EACH ROW UPDATE core_issue i SET i.sequence_count=i.sequence_count - 1
...
) ENGINE=MyISAM AUTO_INCREMENT=36767 DEFAULT CHARSET=utf8;

DELIMITER ;;
/*!50003 SET SESSION SQL_MODE="" */;;
/*!50003 CREATE */ /*!50017 DEFINER=`gcd_dev`@`localhost` */ /*!50003 TRIGGER `pre_insert_series` BEFORE INSERT ON `core_series` FOR EACH ROW SET new.publisher_name=(
        SELECT name FROM core_publisher p WHERE p.id = new.publisher_id) */;;

/*!50003 SET SESSION SQL_MODE="" */;;
/*!50003 CREATE */ /*!50017 DEFINER=`gcd_dev`@`localhost` */ /*!50003 TRIGGER `post_insert_series` AFTER INSERT ON `core_series` FOR EACH ROW UPDATE core_publisher p SET p.series_count = p.series_count + 1,
                                p.issue_count = p.issue_count + new.issue_count
        WHERE p.id = series.publisher_id */;;

/*!50003 SET SESSION SQL_MODE="" */;;
/*!50003 CREATE */ /*!50017 DEFINER=`gcd_dev`@`localhost` */ /*!50003 TRIGGER `pre_update_series` BEFORE UPDATE ON `core_series` FOR EACH ROW IF new.publisher_id != old.publisher_id THEN
        SET new.publisher_name=
...
/*!50003 SET SESSION SQL_MODE="" */;;
/*!50003 CREATE */ /*!50017 DEFINER=`gcd_dev`@`localhost` */ /*!50003 TRIGGER `post_update_series` AFTER UPDATE ON `core_series` FOR EACH ROW BEGIN
...
/*!50003 SET SESSION SQL_MODE="" */;;
/*!50003 CREATE */ /*!50017 DEFINER=`gcd_dev`@`localhost` */ /*!50003 TRIGGER `post_delete_series` AFTER DELETE ON `core_series` FOR EACH ROW UPDATE core_publisher p SET p.series_count=p.series_count - 1,
                                p.issue_count=p.issue_count - old.issue_count
        WHERE p.id = old.publisher_id */;;
...
CREATE TABLE `core_seriescredit` (
  ...
  KEY `IndexerID` (`indexer_id`),
  KEY `SeriesID` (`series_id`)
) ENGINE=MyISAM AUTO_INCREMENT=25139 DEFAULT CHARSET=utf8;
...
-- Dump completed on 2009-05-18  5:25:46
