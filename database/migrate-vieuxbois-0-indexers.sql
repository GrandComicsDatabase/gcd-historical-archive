...
-- Fix Craig Delich's extra account credit problem by consolidating to his
-- usable account.
-- Delete his and Ray's extra accounts.  Craig's has a "don't use" marker
-- and Ray's is not associated with any data.
